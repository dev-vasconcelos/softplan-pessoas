...
public class SourceDTO {
    ...
    public SourceDTO() {        
        ...
        ProjetoDockerComposeDTO projetoComposeJava = new ProjetoDockerComposeDTO("Controle de Pessoas docker-compose utilizando Java Spring", "Rodar front e back individualmente a partir de um docker-compose", composeJavaUrls,"docker-compose run bla bla");
        ...
        ProjetoDockerComposeDTO projetoComposeDotnet = new ProjetoDockerComposeDTO("Controle de Pessoas docker-compose utilizando dotnet", "Rodar front e back individualmente a partir de um docker-compose", composeDotnetUrls, "docker-compose run bla bla");
